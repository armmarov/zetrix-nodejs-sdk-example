...
describe('Test use case no 9747', function() {

  it('test startTx when params.payloadType is 4, source account not exist', function() {
    ...
    co(function* () {
      ...
      let input = {
        ...
        "params": {
          ...
          "remark": "",
          "srcAddress": "ZTX3KYJ7V3xyqox7yXAXxoiZ5DE8QdV6hXE1x",
          "version": "1.0.0",
          "destChainCode": "ab01"
        }
      }
