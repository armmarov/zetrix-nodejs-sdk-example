...
describe('Test use case no 9723', function() {

  it('test sendTx when params.payloadType is 2, contract interoperability repeated', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendTx",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46dbzzz",
          "destAddress": "ZTX3GKJTxYt5kg4RZ8fYAE446DwAoKnLbq1EV",
          "destChainCode": "cz91",
          "extension": "extension",
          "payload": {
