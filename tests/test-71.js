...
describe('Test use case no 9713', function() {

  it('test sendTx when params.payloadType is 2, set the wrong version number', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendTx",
        "params": {
          "crossTxNo": "ab01:cz91:f748eafa60710f7ceb3f150bf46dbbav",
