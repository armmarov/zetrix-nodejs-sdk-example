...
describe('Test use case no 9698', function() {

  it('test sendAcked, send timeout feedback for contract interoperability', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendAcked",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46db1b3",
          "extension": "extension",
          "proof": {
            "ledgerSeq": "63052",
