...
describe('Test use case no 9726', function() {

  it('test sendTx when params.payloadType is 4, duplicate crossTxNo', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendTx",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46dbba3",
          "destAddress": "ZTX3KZxgrmfVYF8NXBEFdnQ3Bq1PERUq4rdcP",
          "destChainCode": "cz91",
          "extension": "extension",
          "payload": {
            "amount": "11"
