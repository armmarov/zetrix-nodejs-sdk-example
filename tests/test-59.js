...
describe('Test use case no 9725', function() {

  it('test sendTx when params.payloadType is 3, data transfer normal condition', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendTx",
        "params": {
          "crossTxNo": "ab01:cz01:f7482afa60710f7ceb3f150bf46ff3c2",
          "destAddress": "ZTX3KYJ7V3xyqox7yXAXxoiZ5DE8QdV6hXE1W",
          "destChainCode": "cz91",
          "extension": "extension",
          "payload": {
            "data": "Test use case 9725"
          },
          "payloadType": "3",
          "proof": {
            "ledgerSeq": "63052",
