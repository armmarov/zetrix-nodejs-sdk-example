...
describe('Test use case no 9699', function() {

  it('test sendAcked, send timeout feedback for data transmission', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendAcked",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46ff3c2",
          "extension": "extension",
          "proof": {
            "ledgerSeq": "63052",
