...
describe('Test use case no 9724', function() {

  it('test sendTx when params.payloadType is 2, contract interoperability', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendTx",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa62710f7ceb3f150bf46db1b3",
