...
const sourceAddress = 'ZTX3KYJ7V3xyqox7yXAXxoiZ5DE8QdV6hXE1A';
...
describe('Test use case no 9740', function() {

  it('test startTx when params.payloadType is 3, pass non-existing source account', function() {
