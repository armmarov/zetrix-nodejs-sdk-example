...
describe('Test use case no 9750', function() {

  it('test startTx when params.payloadType is 2 and payload.contractMethod does not exist', function() {
