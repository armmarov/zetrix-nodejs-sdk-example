...
describe('Test use case no 9700', function() {

  it('test sendAcked, send timeout feedback for asset transfer', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendAcked",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46dbf33",
          "extension": "extension",
          "proof": {
            "ledgerSeq": "63052",
