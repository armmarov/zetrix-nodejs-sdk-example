...
describe('Test use case no 9776', function() {

  it('test startTx when params.srcAddress differs from sourceAddress', function() {
    ...
    co(function* () {
      ...
      let input = {
        ...
        "params": {
          ...
          "remark": "",
          "srcAddress": 'ZTX3c6813ywHTqTuBmiEhn6xD2Sgx4b7Qx5fU',
          "version": "1.0.0",
          "destChainCode": "ab01"
        }
      }
