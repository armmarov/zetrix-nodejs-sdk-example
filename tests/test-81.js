...
describe('Test use case no 9703', function() {

  it('test sendAcked, send failed feedback for asset transfer', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendAcked",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46dbfff",
          "extension": "extension",
          "proof": {
            "ledgerSeq": "63052",
