...
const destinationAddress = "ZTX3GKJTxYt5kg4RZ8fYAE446DwAoKnLbq1EV";
...
describe('Test use case no 9719', function() {

  it('test sendTx when params.payloadType is 2, use non gateway account to send', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendTx",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46dbbce",
