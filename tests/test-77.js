...
describe('Test use case no 9707', function() {

  it('test sendAcked, crosschain ID does not exist during confirmation of asset transfer', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendAcked",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46dbzzc",
          "extension": "extension",
          "proof": {
            "ledgerSeq": "63052",
