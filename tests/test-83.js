...
describe('Test use case no 9701', function() {

  it('test sendAcked, send failed feedback for contract operability', function() {
    ...
    co(function* () {
      ...
      let input = {
        "method": "sendAcked",
        "params": {
          "crossTxNo": "ab01:cz01:f748eafa60710f7ceb3f150bf46db1aa",
          "extension": "extension",
          "proof": {
            "ledgerSeq": "63052",
